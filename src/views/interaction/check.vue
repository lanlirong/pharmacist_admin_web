    ...
    <card class="interaction">
        ...
        <div class="table-container">
            ...
            >
                ...
                <el-table-column prop="name" label="药物名称" sortable="custom" width="120" show-overflow-tooltip> </el-table-column>
                <el-table-column prop="interaction" label="相互作用成分" width="120" show-overflow-tooltip> </el-table-column>
                <el-table-column prop="result" label="相互作用结果" min-width="150" show-overflow-tooltip> </el-table-column>
                ...
                <el-table-column label="操作" width="140" fixed="right">
                    <template slot-scope="{ row }">
                        <router-link :to="`/interaction/check-detail?id=${row.id}`" target="_blank">
                            <el-button v-if="row.status == 0" type="text" size="mini">审核</el-button></router-link
                        >
                        <router-link :to="`/interaction/detail?id=${row.id}&raw=1`" target="_blank">
...
<script>
import { SELECT_TYPE, STATUS } from '@/utils/constant/interaction';
import { _getMyRawList, _deleteRaw } from '@/services/api/interaction';
export default {
